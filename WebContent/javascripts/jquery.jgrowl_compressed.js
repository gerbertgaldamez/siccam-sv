			...
			return this.each(function() {
				...
				if ($.isFunction($(this).data("jGrowl.instance")[m])) {
					$(this).data("jGrowl.instance")[m].apply($(this).data(
							"jGrowl.instance"), $.makeArray(_6).slice(1));
				} else {
						...
						render : function(_1c) {
							...
							$(_1c)
									...
									.bind(
											"jGrowl.open",
											function() {
												if (o.open.apply(_1c, [ _1c,
														_1e, o, _1d.element ]) != false) {
													if (o.glue == "after") {
														$(
									...
									.bind(
											"jGrowl.afterOpen",
											function() {
												o.afterOpen.apply(_1c, [ _1c,
														_1e, o, _1d.element ]);
											})
									.bind(
											"jGrowl.beforeClose",
											function() {
												if (o.beforeClose.apply(_1c, [
														_1c, _1e, o,
														_1d.element ]) != false) {
													$(this).trigger(
															"jGrowl.close");
							...
							if ($("div.jGrowl-notification:parent", _1d.element)
									.size() > 1
									&& $("div.jGrowl-closer", _1d.element)
											.size() == 0
												...
												function() {
													$(this)
															...
															.trigger(
																	"jGrowl.beforeClose");
													if ($
															.isFunction(_1d.defaults.closer)) {
														_1d.defaults.closer
																.apply(
																		$(this)
																				.parent()[0],
