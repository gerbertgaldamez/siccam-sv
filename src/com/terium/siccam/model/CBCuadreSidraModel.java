...
public class CBCuadreSidraModel {
	...
	public void setMontoBoleta(BigDecimal montoBoleta) {
	...
	public String getFechaLiquidacionJ() {
		return fechaLiquidacionJ;
	}
	public void setFechaLiquidacionJ(String fechaLiquidacionJ) {
		this.fechaLiquidacionJ = fechaLiquidacionJ;
	}
	...
	public String getNombrerutaP() {
		return nombrerutaP;
	}
	public void setNombrerutaP(String nombrerutaP) {
		this.nombrerutaP = nombrerutaP;
	}
