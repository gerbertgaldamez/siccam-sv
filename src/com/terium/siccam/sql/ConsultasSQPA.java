...
public class ConsultasSQPA {
	...
	private static String AGREGAR_AGENCIA_VIR_FIS = "INSERT INTO " + " CB_AGENCIA_VIR_FIS " + " ( "
			+ " CBAGENCIASVIRFISID, " + " CBCATALOGOAGENCIAID, " + " CODIGO, " + " NOMBRE, " + " TIPO, "
			+ " CREADO_POR, " + " FECHA_CREADO " + " ) " + " VALUES " + " ( " + " CB_AGENCIA_VIR_FIS_SQ.NEXTVAL, "
			+ " ?, " + " ?, " + " ?, " + " ?, " + " ?, " + " SYSDATE " + " )";
	...
	*/
	...
	private static String INSERT_SISTEMACOMERCIAL_SQ = "INSERT INTO CB_PAGOS (CBPAGOSID, "+ 
			...
			" VALUES(CB_PAGOS_SQ.NEXTVAL, to_date(?,'dd/MM/yyyy hh24:mi:ss'),?,?,?,?,?,?,"+ 
