...
public class CBDialogoCargaPa extends ControladorBase {
	...
	public void cargaConfrontas() throws SQLException, Exception {
		...
		if (cbdb.consultaExistenciaArchivo(nombreArchivo, idMaestro)) {
			// borra archivo
			Logger.getLogger(CBDialogoCargaPa.class.getName()).log(Level.INFO, null, "borra el archivo.");
			Logger.getLogger(CBDialogoCargaPa.class.getName()).log(Level.INFO, null,
					"Nombre archivo: " + nombreArchivo);
			Logger.getLogger(CBDialogoCargaPa.class.getName()).log(Level.INFO, null, "Id Maestro: " + idMaestro);
			Logger.getLogger(CBDialogoCargaPa.class.getName()).log(Level.INFO, null,
		...
		if (dateConfrontas > 1) {
			...
			if (cbdb.ejecutaProcesoSeparacionFechasConfronta(listDataBanco.get(0).getIdCargaMaestro()) > 0) {
				Logger.getLogger(CBDialogoCargaPa.class.getName()).log(Level.INFO,
	...
	public void cargaConfrontaDelDia() throws SQLException, Exception {
		...
		if (cbdb.consultaExistenciaArchivo(nombreArchivo, listDataBanco.get(0).getIdCargaMaestro()))
			try {
				...
				Logger.getLogger(CBDialogoCargaPa.class.getName()).log(Level.SEVERE, null, e);
			}
