...
public class Constantes {
	...
	public static final String ENCABEZADO_CONCILIACION_BANCOS = "Fecha|Entidad|Codigo Colector|"
			+ "Estado confronta|Confronta|Diferencia confronta|"
			+ "Pagos del dia|Pagos otros dias|Pagos otros meses|"
			+ "Reversas otros dias|Reversas otros meses|Total dia|Total general|"
			+ "Estado cuenta|Diferencia total|Porcentaje|Comision confronta|"
			+ "Comision|Diferencia comision|"
			+ "Comision total|Recaudacion final|"
			+ "Total final\n";
